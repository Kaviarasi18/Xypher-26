  ...
  return (
    <motion.div
      ...
      <div className="absolute left-5 top-20 z-30 flex flex-col gap-3">
        ...
        <button
          onClick={onBack}
          className="md:hidden flex items-center gap-2 border border-primary/50 px-5 py-2 rounded-full font-rajdhani uppercase tracking-[0.15em] text-xs text-primary hover:bg-primary/20 hover:border-primary transition-all border-glow bg-background/60 backdrop-blur-sm">
      ...
      <div className="relative z-20 flex h-[calc(100vh-52px)]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 md:px-16">
          ...
          <motion.div
            ...
            {/* Back button */}
            <motion.button
              className="flex items-center gap-2 border border-primary/50 px-8 py-3 rounded-full font-rajdhani uppercase tracking-[0.15em] text-xs text-primary hover:bg-primary/20 hover:border-primary transition-all border-glow bg-background/60 backdrop-blur-sm"
            ...
            {/* Register button */}
            <motion.button
              className="flex items-center gap-3 border border-primary px-10 py-3 rounded-full font-rajdhani uppercase tracking-[0.15em] text-xs text-white font-bold bg-primary/60 hover:bg-primary/80 transition-all border-glow backdrop-blur-sm shadow-lg hover:shadow-[0_0_30px_rgba(var(--primary),0.8)]"
      ...
      {/* Smoke - subtle on detail page */}
      <SmokeEffect density={35} heightClass="h-screen" />
    </motion.div>);
